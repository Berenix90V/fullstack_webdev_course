describe("Blog list app", function () {
  ...
  describe("when logged in", function () {
    ...
    it("a new blog can be created", function () {
      ...
      cy.contains("A new blog is created", { exact: false }).should(
        "have.css",
        "color",
        "rgb(0, 128, 0)",
      );
    ...
    describe("when more blogs and users exist", function () {
      ...
      it("the user that posted the blog can delete it", function () {
        cy.contains(
          `${blogCreatedByMatti.title} by ${blogCreatedByMatti.author}`,
        )
          .contains("delete")
          .click();
        cy.contains(
      ...
      it("the user can delete only its own posts", function () {
        ...
        cy.contains(
          `${blogCreatedBySuperuser.title} by ${blogCreatedBySuperuser.author}`,
        )
          .contains("delete")
          .should("not.exist");
      });
